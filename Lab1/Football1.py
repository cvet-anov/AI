...
def protivnici (topkax, topkay, opponents):
    for (a,b) in opponents:
        if (a,b)==(topkax+1,topkay) or (a,b)==(topkax+1,topkay+1) or (a,b)==(topkax+1,topkay_1) or (a,b)==(topkax,topkay+1) or (a,b)==(topkax,topkay-1) or (a, b)==(topkax-1,topkay+1) or (a, b)==(topkax-1,topkay) or (a,b)==(topkax-1,topkay-1):
            return False
    return True
